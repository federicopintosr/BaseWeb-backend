--Para HOME CAROUSEL
insert into slides values (1,1,'HOME','Slide 1','../../assets/pages/img/shop-slider/slide1/bg.jpg','V',now(),now());
insert into slides values (2,2,'HOME','Slide 2','../../assets/pages/img/shop-slider/slide2/bg.jpg','V',now(),now());
insert into slides values (3,3,'HOME','Slide 3','../../assets/pages/img/shop-slider/slide3/bg.jpg','V',now(),now());
insert into slides values (4,4,'HOME','Slide 4','../../assets/pages/img/shop-slider/slide4/bg.jpg','V',now(),now());
insert into slides values (5,5,'HOME','Slide 4','../../assets/pages/img/shop-slider/slide4/bg.jpg','V',now(),now());

--Para Nuevos Ingresos
insert into arrivals values (1,1,'HOME','VESTIDO AZUL',1,235.56,'../../assets/pages/img/products/model1.jpg','V',now(),now());
